...
public class ConsultarVuelosBase extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarVuelosBase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarVuelosBase dialog = new ConsultarVuelosBase(new javax.swing.JFrame(), true);
